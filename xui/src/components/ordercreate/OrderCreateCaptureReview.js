...
import './OrderCreateCaptureReview.css'
...
export default class OrderCreateCaptureReview extends Component {
  ...
  setEditGetProducts = (num, noaddit, cstandard) => {
    ...
    var edit = num === 0 ? 'Only ' : num === 1 ? 'Single Photo with ' : num === 2 ? '4-Pack Photos with ' : num === 3 ? '5-Pack Photos with ' : '360 Spin with ';
