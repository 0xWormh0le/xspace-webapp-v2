...
>>>>>>> Temporary merge branch 2
    ...
    if (singleMode) {
          ...
          <MDBCol md="12" >
            <span className="batch-order-span" color="dark" style={{ width: "100%" }}>
              <div className="clearfix">
                ...
                <MDBBtn className="float-right" rounded color="blue" onClick={() => {this.props.toggleBatchModal(0)}}><i className="fa fa-pencil-square-o" aria-hidden="true"></i>     Select Services</MDBBtn>
                <MDBBtn className="float-right" rounded color="green" onClick={() => {this.props.toggleProductsModal(0)}}><i className="fa fa-plus-circle" aria-hidden="true"></i>     Add Products</MDBBtn>
              </div>
            </span>
      ...
      batchView = this.props.batchView
    }
