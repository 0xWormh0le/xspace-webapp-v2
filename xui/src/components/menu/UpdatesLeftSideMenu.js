    ...
    return (
        <div className="account-left">
          <ul className="list-unstyled">
            ...
            <li key={2} className="left-menu-bar-api-active">
              <img src="/media/product-update-icon.png" alt="apps icon"/>
              <Link to="/products/manage" className="menu-font">PRODUCT UPDATES</Link>
              <div className="arrow-left2" style={{marginLeft:240, marginTop: -49}}></div>
            </li>
